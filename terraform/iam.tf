    ...
    Statement = [
      {
        ...
        Resource = [
          aws_s3_bucket.mempool_data_bucket.arn,
          "${aws_s3_bucket.mempool_data_bucket.arn}/*"
        ]
      }
    ]
...
resource "aws_iam_role_policy" "ec2_firehose_write" {
  name = "${var.project_name}-ec2-firehose-write"
    ...
    Statement = [
      {
        ...
        Resource = [
          aws_cloudwatch_log_group.mempool_ec2.arn,
          "${aws_cloudwatch_log_group.mempool_ec2.arn}:*"
        ]
      }
    ]
